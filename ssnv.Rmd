...
library(magrittr)
img <- "https://github.com/harkanatta/ssnv_trident/blob/master/graphs/tvologo.jpg?raw=true"
myndir=c("skjol/skogar/sk2/stodvar/st1/sk2-st1B.jpg","skjol/skogar/sk2/stodvar/st2/sk2-st2.jpeg","skjol/skogar/sk2/stodvar/st3/ekkert.png")
map <- mapview(stodvar,map.types="Esri.WorldImagery",cex=14, popup = popupImage(myndir))
map %>% leafem::addLogo(img, width = '20%', height = '25%',offset.y = 20,offset.x = 80,alpha = 0.7) %>% leaflet.extras::addFullscreenControl(pseudoFullscreen = T)
...
library(magrittr)
img <- "https://github.com/harkanatta/ssnv_trident/blob/master/graphs/tvologo.jpg?raw=true"
map <- mapview(stodvar,map.types="Esri.WorldImagery",cex=14)
map %>% leafem::addLogo(img, width = '20%', height = '25%',offset.y = 20,offset.x = 80,alpha = 0.7) %>% leaflet.extras::addFullscreenControl(pseudoFullscreen = T)
```
