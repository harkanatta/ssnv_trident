...
map %>% leafem::addLogo(img, width = '15%', height = '20%',offset.y = 20,offset.x = 80,alpha = 0.7) %>% leaflet.extras::addFullscreenControl(pseudoFullscreen = T)
...
```{r mynd-sk-fimm-stod-eitt,echo = FALSE,	fig.align = "center",	message = FALSE,	warning = FALSE,	out.width='100%',	error=FALSE, fig.cap='*Stöð 1*. Hrossaþari eða stórþari (*Laminaria digitata* eða *Laminaria hyperborea*) og marinkjarni (*Alaria esculenta*)'}

knitr::include_graphics("skjol/skogar/sk5/stodvar/st1/sk5-st1.jpg")

```

```{r mynd-sk-fimm-stod-tvo,echo = FALSE,	fig.align = "center",	message = FALSE,	warning = FALSE,	out.width='100%',	error=FALSE, fig.cap='*Stöð 2*. Hrossaþari eða stórþari (*Laminaria digitata* eða *Laminaria hyperborea*) og marinkjarni (*Alaria esculenta*)'}
